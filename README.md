...
Please select a paper to present from the following list. Once a paper is assigned to a presenter, the presenter's name together with the "🔴" symbol is posted next to the title of the paper. 
